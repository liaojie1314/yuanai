...
describe('useVoiceInput', () => {
  ...
  it('falls back to Whisper when Chromium speech recognition is unavailable', async () => {
  ...
  it('uses a local final transcript without uploading the retained recording', async () => {
    const onTranscript = vi.fn()
    ...
    const onresult = MockSpeechRecognition.latest?.onresult
  ...
  it('reports empty audio and never inserts text', async () => {
