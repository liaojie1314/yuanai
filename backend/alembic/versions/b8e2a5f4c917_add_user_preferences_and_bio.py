...
def upgrade() -> None:
    ...
    op.add_column(
        "users", sa.Column("theme", sa.String(length=10), nullable=False, server_default="auto")
    )
    op.add_column(
        "users",
    ...
    op.add_column(
        "users",
        sa.Column("density", sa.String(length=10), nullable=False, server_default="standard"),
    )
    op.add_column(
        "users", sa.Column("time_format", sa.String(length=5), nullable=False, server_default="24h")
    )
    op.add_column(
        "users", sa.Column("date_format", sa.String(length=5), nullable=False, server_default="ymd")
    )
    op.add_column(
        "users", sa.Column("language", sa.String(length=10), nullable=False, server_default="zh-CN")
    )
