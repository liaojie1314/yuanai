...
down_revision: Union[str, None] = 'd5e8a1c2f3b4'
...
def upgrade() -> None:
    ...
    op.create_index(
        'ix_file_upload_sessions_user_id', 'file_upload_sessions', ['user_id']
    )
...
def downgrade() -> None:
    op.drop_index(
        'ix_upload_sessions_user_hash_status', table_name='file_upload_sessions'
    )
